...
public sealed record class BusinessCategoryValue
{
    ...
    private static readonly BusinessCategoryValue Agriculture 
        = new BusinessCategoryValue("農業、林業、漁業");

    /// <summary> 鉱業、採石業、砂利採取業 </summary>
    private static readonly BusinessCategoryValue Mining 
        = new BusinessCategoryValue("鉱業、採石業、砂利採取業");

    /// <summary> 建設業 </summary>
    private static readonly BusinessCategoryValue Construction
        = new BusinessCategoryValue("建設業");
    
    /// <summary> 食料品、飲料・たばこ・飼料製造業 </summary>
    private static readonly BusinessCategoryValue Food
        = new BusinessCategoryValue("食料品、飲料・たばこ・飼料製造業");

    /// <summary> 繊維工業 </summary>
    private static readonly BusinessCategoryValue Textile
        = new BusinessCategoryValue("繊維工業");
    
    /// <summary> 木材・木製品、パルプ・紙・紙加工品製造業 </summary>
    private static readonly BusinessCategoryValue Timber
        = new BusinessCategoryValue("木材・木製品、パルプ・紙・紙加工品製造業");

    /// <summary> 化学工業 </summary>
    private static readonly BusinessCategoryValue Chemistry
        = new BusinessCategoryValue("化学工業");
    
    /// <summary> 石油製品・石炭製品製造業 </summary>
    private static readonly BusinessCategoryValue Petroleum
        = new BusinessCategoryValue("石油製品・石炭製品製造業");

    /// <summary> 窯業・土石製品製造業 </summary>
    private static readonly BusinessCategoryValue Pottery
        = new BusinessCategoryValue("窯業・土石製品製造業");

    /// <summary> 鉄鋼業 </summary>
    private static readonly BusinessCategoryValue Steel
        = new BusinessCategoryValue("鉄鋼業");

    /// <summary> 非鉄金属製造業 </summary>
    private static readonly BusinessCategoryValue NonFerrousMetalworking
        = new BusinessCategoryValue("非鉄金属製造業");

    /// <summary> 金属製品製造業 </summary>
    private static readonly BusinessCategoryValue Metalware
        = new BusinessCategoryValue("金属製品製造業");

    /// <summary> はん用機械器具製造業 </summary>
    private static readonly BusinessCategoryValue GeneralMetalware
        = new BusinessCategoryValue("はん用機械器具製造業");

    /// <summary> 生産用機械器具製造業 </summary>
    private static readonly BusinessCategoryValue Production
        = new BusinessCategoryValue("生産用機械器具製造業");

    /// <summary> 業務用機械器具製造業 </summary>
    private static readonly BusinessCategoryValue Operation
        = new BusinessCategoryValue("業務用機械器具製造業");
    
    /// <summary> 電気機械器具製造業 </summary>
    private static readonly BusinessCategoryValue Electrodynamic
        = new BusinessCategoryValue("電気機械器具製造業");
    
    /// <summary> 情報通信機械器具、電子部品・デバイス・電子回路製造業 </summary>
    private static readonly BusinessCategoryValue Device
        = new BusinessCategoryValue("情報通信機械器具、電子部品・デバイス・電子回路製造業");

    /// <summary> 輸送機械器具製造業 </summary>
    private static readonly BusinessCategoryValue TransportMachinery
        = new BusinessCategoryValue("輸送機械器具製造業");
    
    /// <summary> その他の製造業 </summary>
    private static readonly BusinessCategoryValue OtherManufacture
        = new BusinessCategoryValue("その他の製造業");
    
    /// <summary> 電気・ガス・熱供給・水道業 </summary>
    private static readonly BusinessCategoryValue Electricity
        = new BusinessCategoryValue("電気・ガス・熱供給・水道業");
    
    /// <summary> 情報通信業 </summary>
    private static readonly BusinessCategoryValue Telecommunications 
        = new BusinessCategoryValue("情報通信業");
    
    /// <summary> 運輸業 </summary>
    private static readonly BusinessCategoryValue Transportation
        = new BusinessCategoryValue("運輸業");

    /// <summary> 卸売業、小売業 </summary>
    private static readonly BusinessCategoryValue Wholesale 
        = new BusinessCategoryValue("卸売業、小売業");

    /// <summary> 金融業、保険業 </summary>
    private static readonly BusinessCategoryValue Finance
        = new BusinessCategoryValue("金融業、保険業");
    
    /// <summary> 不動産業 </summary>
    private static readonly BusinessCategoryValue RealEstate
        = new BusinessCategoryValue("不動産業");
    
    /// <summary> 宿泊業、飲食サービス業 </summary>
    private static readonly BusinessCategoryValue LodgingAndFood
        = new BusinessCategoryValue("宿泊業、飲食サービス業");
    
    /// <summary> 教育、学習支援、医療、福祉、複合サービス業 </summary>
    private static readonly BusinessCategoryValue Education
        = new BusinessCategoryValue("教育、学習支援、医療、福祉、複合サービス業");

    /// <summary> サービス業 </summary>
    private static readonly BusinessCategoryValue Service
        = new BusinessCategoryValue("サービス業");
    ...
    {
        if (no == 0) throw new Exceptions.FormatException("業種の中区分が不正値です。");
        ...
        throw new Exceptions.FormatException("業種の中区分が登録されていません。");
    }
    ...
    {
        if (largeCategory == null) throw new Exceptions.FormatException("業種の大分類が不正値です。");
    ...
    public override string ToString() => this.LargeName;
}
