...
";
            ...
            var args = new List<SQLiteParameter>()
            {
                ...
                new SQLiteParameter("WorkingStart",            DateUtils.ConvertToSQLiteValue(entity.WorkingStart.Year, entity.WorkingStart.Month, entity.WorkingStart.Day)),
                new SQLiteParameter("WorkingEnd",              DateUtils.ConvertToSQLiteValue(entity.WorkingEnd.Year, entity.WorkingEnd.Month, entity.WorkingEnd.Day)),
