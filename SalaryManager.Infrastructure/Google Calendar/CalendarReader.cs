...
public static class CalendarReader
{
    ...
    /// </remarrks>
    private static Google.Apis.Calendar.v3.CalendarService Initialize()
    {
    ...
    /// </remarks>
    private static IReadOnlyList<Google.Apis.Calendar.v3.Data.Event> GetEvents(Google.Apis.Calendar.v3.CalendarService service)
    {
        if (service is null)
        {
        ...
        var schedules = new List<Google.Apis.Calendar.v3.Data.Event>();
